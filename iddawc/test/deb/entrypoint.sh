...
if [ -f $IDDAWC_ARCHIVE ]; then
  ...
  gcc -Wall -D_REENTRANT -I../include -DDEBUG -g -O0 session.c -o session -lc -lorcania -liddawc -lrhonabwy -ljansson -lyder -lcheck_pic -pthread -lrt -lm -lsubunit -lulfius -lgnutls
  gcc -Wall -D_REENTRANT -I../include -DDEBUG -g -O0 rar.c -o rar -lc -lorcania -liddawc -lrhonabwy -ljansson -lyder -lcheck_pic -pthread -lrt -lm -lsubunit -lulfius -lgnutls
